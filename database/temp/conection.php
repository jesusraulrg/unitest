...
$usuario = "armando"; // usuario de la base de datos
$contraseña = "UxK*ZdBXz0-1AkOt"; // contraseña de la base de datos
$base_de_datos = "integradora"; // nombre de la base de datos
